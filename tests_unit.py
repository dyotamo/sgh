...
from utils.validators import (
    validate_check_in_creation, validate_guest, validate_reservation,)


class TestValidators(TestCase):
    def test_invalid_check_in(self):
        with self.assertRaises(AttributeError):
            validate_check_in_creation(dict(check_out_time=date(2020, 9, 5)))
    ...
    def test_invalid_company(self):
        with self.assertRaises(AttributeError):
            validate_guest(dict(telephone='+258840000000',
                                cellphone='+2588915652',
                                fax='+2588915652',
                                nuit='100000008'))

    def test_valid_company(self):
        validate_guest(dict(telephone='+258840000000',
                            cellphone='+258840000000',
                            fax='+258840000000',
                            nuit='100000008'))
